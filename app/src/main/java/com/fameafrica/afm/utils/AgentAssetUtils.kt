...
object AgentAssetUtils {
    ...
    fun getAgentFace(
        ...
        val pool = when (region) {
            ...
            FootballRegion.WEST_AFRICA -> listOf("file:///android_asset/agent_faces/westafrica_3_3.jpg") + generatePaths("OIG1", 3, 6)
            else -> generatePaths("Prof", 5, 4) + generatePaths("OIG4", 3, 6)
        }

        if (pool.isEmpty()) return "file:///android_asset/agent_faces/northafrica_5_4_4.jpg"
    ...
    private fun generatePaths(prefix: String, range1: Int, range2: Int): List<String> {
        ...
        for (i in 1..range1) {
            for (j in 1..range2) {
                ...
                list.add("file:///android_asset/agent_faces/${prefix}_${i}_${j}.jpg")
                list.add("file:///android_asset/agent_faces/${prefix}__${i}_${j}.jpg")
                list.add("file:///android_asset/agent_faces/${prefix}_${i}_1_${j}.jpg")
            }
        }
